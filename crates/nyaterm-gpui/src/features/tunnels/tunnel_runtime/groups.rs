...
impl NyaTermApp {
    pub(in crate::features) fn handle_tunnel_search_key_down(
        &mut self,
        event: &KeyDownEvent,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::features) fn handle_proxy_search_key_down(
        &mut self,
        event: &KeyDownEvent,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::features) fn save_proxy_group(&mut self, group_id: Option<String>, name: String, cx: &mut Context<Self>) {
    ...
    pub(in crate::features) fn delete_tunnel_group(&mut self, group_id: String, label: String, cx: &mut Context<Self>) {
        let groups = self
            .tunnel_groups
            .iter()
    ...
    pub(in crate::features) fn delete_proxy_group(&mut self, group_id: String, label: String, cx: &mut Context<Self>) {
        let groups = self
            .proxy_groups
            .iter()
            .filter(|group| group.id != group_id)

...
impl NyaTermApp {
    pub(in crate::ui::view) fn prompt_recording_path(
        &mut self,
    ...
    pub(in crate::ui::view) fn prompt_recording_path_for_session(
        &mut self,
        kind: RecordingPathPromptKind,
        session_id: String,
        session_name: String,
    ...
    pub(in crate::ui::view) fn stop_recording_for_session(
        &mut self,
        session_id: &str,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::ui::view) fn handle_recording_search_key_down(
        &mut self,
        event: &KeyDownEvent,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::ui::view) fn recording_search_results(
        &self,

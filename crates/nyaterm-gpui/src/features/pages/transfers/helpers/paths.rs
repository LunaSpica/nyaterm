...
pub(in crate::features::pages::transfers) fn remote_sibling_path(old_path: &str, new_name: &str) -> String {
...
pub(in crate::features::pages::transfers) fn remote_child_path(parent: &str, child_name: &str) -> String {
...
pub(in crate::features::pages::transfers) fn normalized_transfer_browser_path(path: &str) -> String {
...
pub(in crate::features::pages::transfers) const TRANSFER_BROWSER_ACTIONS_WIDTH: gpui::Pixels = px(360.);
const TRANSFER_BROWSER_COLUMN_GAP_TOTAL: gpui::Pixels = px(48.);

pub(in crate::features::pages::transfers) fn transfer_browser_table_width(widths: TransferBrowserColumnWidths) -> gpui::Pixels {
    widths.name
        + widths.modified
        + widths.size
        + widths.permissions
...
pub(in crate::features::pages::transfers) fn transfer_path_part_value(path: &str, part: TransferPathPart) -> String {
    match part {

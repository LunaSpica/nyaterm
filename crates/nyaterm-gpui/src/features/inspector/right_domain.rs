...
impl NyaTermApp {
    pub(in crate::features) fn right_stats_panel(&mut self, cx: &mut Context<Self>) -> impl IntoElement {
    ...
    pub(in crate::features) fn right_process_panel(&mut self, cx: &mut Context<Self>) -> impl IntoElement {
        let palette = self.theme_palette();
    ...
    pub(in crate::features) fn right_docker_panel(&mut self, cx: &mut Context<Self>) -> impl IntoElement {
        let palette = self.theme_palette();
    ...
    pub(in crate::features) fn right_translation_panel(&mut self, cx: &mut Context<Self>) -> impl IntoElement {
        let palette = self.theme_palette();
        let translated = self
            .translate_result
            .as_ref()

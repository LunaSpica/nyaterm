...
impl NyaTermApp {
    ...
    pub(in crate::features) fn group_is_descendant(&self, candidate_id: &str, ancestor_id: &str) -> bool {
    ...
    pub(in crate::features) fn persist_connection_order(&mut self, ordered: &[SavedConnection]) -> Result<(), String> {
    ...
    pub(in crate::features) fn persist_group_order(&mut self, ordered: &[Group]) -> Result<(), String> {
        self.with_connection_store(|store| {

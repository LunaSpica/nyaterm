...
impl NyaTermApp {
    pub(in crate::features) fn command_center_panel(&mut self, cx: &mut Context<Self>) -> impl IntoElement {
    ...
    pub(in crate::features) fn command_search_panel(&mut self, cx: &mut Context<Self>) -> impl IntoElement {
        let palette = self.theme_palette();
    ...
    pub(in crate::features) fn command_history_panel(&mut self, cx: &mut Context<Self>) -> impl IntoElement {
        let palette = self.theme_palette();

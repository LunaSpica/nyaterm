...
impl NyaTermApp {
    pub(in crate::features) fn ai_message_bubble(&self, message: &AiMessage, cx: &mut Context<Self>) -> impl IntoElement {
    ...
    pub(in crate::features) fn ai_assistant_panel(&mut self, cx: &mut Context<Self>) -> impl IntoElement {
    ...
    pub(in crate::features) fn right_ai_command_panel(&mut self, cx: &mut Context<Self>) -> impl IntoElement {
        div()
            .flex()
            .flex_col()
            .gap_3()

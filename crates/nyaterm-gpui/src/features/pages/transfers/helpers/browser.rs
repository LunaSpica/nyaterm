...
pub(in crate::features::pages::transfers) fn transfer_browser_search_status(query: &str, visible: usize, total: usize) -> String {
...
pub(in crate::features::pages::transfers) fn natural_compare_ascii(left: &str, right: &str) -> Ordering {

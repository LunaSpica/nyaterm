...
impl NyaTermApp {
    pub(in crate::ui::view) fn upsert_ai_agent_step(
        &mut self,
        step_index: u16,
    ...
    pub(in crate::ui::view) fn begin_ai_agent_observation(
        &mut self,
        command: &str,
    ...
    pub(in crate::ui::view) fn begin_ai_agent_background_execution(
        &mut self,
        command: &str,
        cx: &mut Context<Self>,
    ) -> Result<(), String> {
    ...
    pub(in crate::ui::view) fn start_ai_agent_continuation(
        &mut self,

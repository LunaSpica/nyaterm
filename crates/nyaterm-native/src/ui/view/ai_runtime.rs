...
impl NyaTermApp {
    ...
    pub(in crate::ui::view) fn expand_ai_credential(
        &mut self,
        credential_id: String,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::ui::view) fn focus_ai_credential_field(
        &mut self,
        credential_id: String,
    ...
    pub(in crate::ui::view) fn handle_ai_credential_key_down(
        &mut self,
        event: &KeyDownEvent,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::ui::view) fn persist_ai_credential_edits(
        &mut self,
        credential_id: &str,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::ui::view) fn add_ai_credential(
        &mut self,
        window: &mut Window,
        cx: &mut Context<Self>,
    ) {
        ...
        let credential = nyaterm_domain::AiProviderCredential {
            id: id.clone(),
            name: "Custom Provider".to_string(),
            provider_kind: nyaterm_domain::AiProviderKind::OpenaiCompatible,
    ...
    pub(in crate::ui::view) fn remove_ai_credential(
        &mut self,
        credential_id: String,
        cx: &mut Context<Self>,
    ) {
...
fn seed_builtin_ai_models_for_provider(
    settings: &mut nyaterm_domain::AiSettings,
    provider_kind: &nyaterm_domain::AiProviderKind,
) {
    let names: &[&str] = match provider_kind {
        nyaterm_domain::AiProviderKind::Openai => &[
            "gpt-4o-mini",
            "gpt-4o",
            "gpt-4.1",
            "gpt-4.1-mini",
        ...
        nyaterm_domain::AiProviderKind::Anthropic => &[
            "claude-3-haiku-20240307",
            "claude-3-5-sonnet-20241022",
            "claude-sonnet-4-20250514",
        ],
        nyaterm_domain::AiProviderKind::Gemini => &["gemini-2.0-flash", "gemini-1.5-pro"],
        nyaterm_domain::AiProviderKind::Deepseek => &["deepseek-chat", "deepseek-reasoner"],
        nyaterm_domain::AiProviderKind::Ollama => &["llama3", "llama3.1", "qwen2.5"],
        nyaterm_domain::AiProviderKind::Xai => &["grok-3", "grok-2"],
        nyaterm_domain::AiProviderKind::Cohere => &["command-a-03-2025", "command-r-plus"],
        nyaterm_domain::AiProviderKind::Mimo => &["mimo-v2.5-pro"],
        nyaterm_domain::AiProviderKind::Zai => &["glm-4", "glm-4-flash"],
    ...
    for name in names {
        ...
        settings.models.push(nyaterm_domain::AiModelConfigItem {
            id: model_id,
            name: (*name).to_string(),
            provider_kind: Some(provider_kind.clone()),
            credential_id: None,
            enabled: false,
            source: nyaterm_domain::AiModelSource::RustGenai,
            last_seen_at: None,
        });
    }
}

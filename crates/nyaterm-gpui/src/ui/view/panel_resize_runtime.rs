...
impl NyaTermApp {
    pub(in crate::ui::view) fn start_panel_resize(
        &mut self,
    ...
    pub(in crate::ui::view) fn update_panel_resize(
        &mut self,
    ...
    pub(in crate::ui::view) fn finish_panel_resize(
        &mut self,
        _event: &MouseUpEvent,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::ui::view) fn apply_ui_layout_from_settings(&mut self) {
    ...
    pub(in crate::ui::view) fn panel_resize_handle(
        &self,
        side: PanelResizeSide,
        cx: &mut Context<Self>,
    ) -> impl IntoElement {
...
impl NyaTermApp {
    pub(in crate::ui::view) fn start_transfer_height_resize(
        &mut self,
        event: &MouseDownEvent,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::ui::view) fn update_transfer_height_resize(
        &mut self,
        event: &MouseMoveEvent,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::ui::view) fn finish_transfer_height_resize(
        &mut self,
        _event: &MouseUpEvent,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::ui::view) fn transfer_height_resize_handle(
        &self,
        cx: &mut Context<Self>,
    ) -> impl IntoElement {
        let palette = self.theme_palette();

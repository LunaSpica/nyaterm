...
pub(in crate::features::pages::transfers) fn editor_content_preview(content: &str, query: &str, active_match: usize) -> String {
...
pub(in crate::features::pages::transfers) fn editor_search_matches(content: &str, query: &str) -> Vec<usize> {
...
pub(in crate::features::pages::transfers) fn format_permissions_symbolic(file_type: SftpFileType, mode: u32) -> String {

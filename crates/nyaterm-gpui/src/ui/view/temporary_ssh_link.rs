use super::*;
use crate::ui::temporary_ssh_link::{TemporarySshLinkConfig, parse_temporary_ssh_link};

impl NyaTermApp {
    pub(in crate::ui::view) fn open_temporary_ssh_link_dialog(
        &mut self,
        window: &mut Window,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::ui::view) fn close_temporary_ssh_link_dialog(&mut self, cx: &mut Context<Self>) {
    ...
    pub(in crate::ui::view) fn handle_temporary_ssh_link_key_down(
        &mut self,
        event: &KeyDownEvent,
        window: &mut Window,
        cx: &mut Context<Self>,

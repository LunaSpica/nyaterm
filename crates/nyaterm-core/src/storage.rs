...
use crate::{
    ...
    CredentialCrypto, CredentialCryptoError, Group, KeywordHighlightConfig,
    ...
    QuickCommandCategory, QuickCommandsConfig, SavedConnection, SearchEngineConfig, SessionsConfig,
    TranslationSettings, TunnelConfig, TunnelGroup, TunnelGroupsConfig, ai_settings_has_secret,
    default_search_engines, merge_masked_ai_settings, merge_masked_cloud_sync_settings,
...
mod tests {
    use super::*;
    use crate::{
        AiExecutionProfile, CommandHistoryEntry, ConnectionAuth, ConnectionType, OtpEntry, SshKey,
    };

...
use crate::models::{
    ...
    SearchEngineEditorField, SettingsTab, StartupCommandAction, StoreStatus, TerminalFramePipeline,
    TerminalSearchMode, TranslateInputField, TranslationSecretDraft,
};
    ...
    pub fn new(
        ...
        Self {
            ...
            remote_ops: RemoteOpsFeatureState::new(RemoteOpsFeatureFocus {
                docker_search: cx.focus_handle(),
                process_search: cx.focus_handle(),
                process_nice: cx.focus_handle(),
            }),
            ...
            ai_history_job_id: 0,
            ai_history_pending: false,
            ai_usage_count_job_id: 0,
            ai_audit_write_lock: Arc::new(Mutex::new(())),
            ...
            ai_settings_model_query: String::new(),
            ai_settings_model_search_focus: cx.focus_handle(),
            ...
            terminal_live_prefetch_generation: 0,
            terminal_live_prefetch_task: None,

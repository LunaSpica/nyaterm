...
impl NyaTermApp {
    pub(in crate::ui::view) fn lock_app(&mut self, window: &mut Window, cx: &mut Context<Self>) {
        self.is_locked = true;
    ...
    pub(in crate::ui::view) fn unlock_app(&mut self, cx: &mut Context<Self>) {
    ...
    pub(in crate::ui::view) fn submit_lock_unlock(&mut self, cx: &mut Context<Self>) {
    ...
    pub(in crate::ui::view) fn handle_lock_key_down(
        &mut self,
        event: &KeyDownEvent,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::ui::view) fn reveal_log_dir(&mut self, cx: &mut Context<Self>) {
    ...
    pub(in crate::ui::view) fn prompt_diagnostics_export(&mut self, cx: &mut Context<Self>) {
    ...
    pub(in crate::ui::view) fn apply_diagnostics_path_prompt_result(
        &mut self,
    ...
    pub(in crate::ui::view) fn diagnostics_export_options(&self) -> DiagnosticsExportOptions {
    ...
    pub(in crate::ui::view) fn diagnostics_runtime_snapshot(&self) -> DiagnosticsRuntimeSnapshot {

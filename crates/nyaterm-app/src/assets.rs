...
const ICON_FILES: &[&str] = &[
    ...
    "icons/menu/article.svg",
    "icons/menu/book.svg",
    "icons/menu/broadcast.svg",
    "icons/menu/export.svg",
    "icons/menu/fit.svg",
    "icons/menu/horizontal.svg",
    "icons/menu/info.svg",
    "icons/menu/menu.svg",
    "icons/menu/palette.svg",
    "icons/menu/reset.svg",
    "icons/menu/sidebar.svg",
...
fn icon_bytes(path: &str) -> Option<&'static [u8]> {
    match path {
        ...
        "icons/view-list.svg" => Some(include_bytes!("../assets/icons/view-list.svg")),
        ...
        "icons/conn/symlink.svg" => Some(include_bytes!("../assets/icons/conn/symlink.svg")),
        ...
        "icons/transfer/pause.svg" => Some(include_bytes!("../assets/icons/transfer/pause.svg")),
        "icons/transfer/play.svg" => Some(include_bytes!("../assets/icons/transfer/play.svg")),
        "icons/transfer/playlist-remove.svg" => Some(include_bytes!(
            "../assets/icons/transfer/playlist-remove.svg"
        )),
        "icons/transfer/stop.svg" => Some(include_bytes!("../assets/icons/transfer/stop.svg")),
        "icons/menu/article.svg" => Some(include_bytes!("../assets/icons/menu/article.svg")),
        "icons/menu/book.svg" => Some(include_bytes!("../assets/icons/menu/book.svg")),
        "icons/menu/broadcast.svg" => Some(include_bytes!("../assets/icons/menu/broadcast.svg")),
        "icons/menu/export.svg" => Some(include_bytes!("../assets/icons/menu/export.svg")),
        "icons/menu/fit.svg" => Some(include_bytes!("../assets/icons/menu/fit.svg")),
        "icons/menu/horizontal.svg" => Some(include_bytes!("../assets/icons/menu/horizontal.svg")),
        "icons/menu/info.svg" => Some(include_bytes!("../assets/icons/menu/info.svg")),
        "icons/menu/menu.svg" => Some(include_bytes!("../assets/icons/menu/menu.svg")),
        "icons/menu/palette.svg" => Some(include_bytes!("../assets/icons/menu/palette.svg")),
        "icons/menu/reset.svg" => Some(include_bytes!("../assets/icons/menu/reset.svg")),
        "icons/menu/sidebar.svg" => Some(include_bytes!("../assets/icons/menu/sidebar.svg")),
        "icons/menu/split.svg" => Some(include_bytes!("../assets/icons/menu/split.svg")),
        "icons/menu/update.svg" => Some(include_bytes!("../assets/icons/menu/update.svg")),
        "icons/menu/vertical.svg" => Some(include_bytes!("../assets/icons/menu/vertical.svg")),
        "icons/menu/zoom-in.svg" => Some(include_bytes!("../assets/icons/menu/zoom-in.svg")),
        "icons/menu/zoom-out.svg" => Some(include_bytes!("../assets/icons/menu/zoom-out.svg")),
...
impl AssetSource for NyaTermAssets {
    ...
    fn list(&self, path: &str) -> Result<Vec<SharedString>> {
        ...
        if normalized.is_empty()
            ...
            || normalized == "icons/fe"
            || normalized == "icons/ai"
            || normalized == "icons/menu"
            || normalized == "icons/transfer"

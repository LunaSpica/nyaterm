...
pub(in crate::features) use types::{
    PendingSessionStart, SessionPaneState, TerminalRuntimeUiState,
};
...
pub struct NyaTermApp {
    ...
    pub(in crate::features) connection_details_tooltip_id: Option<String>,
    pub(in crate::features) connection_details_hover_pending: Option<(String, Instant)>,
    ...
    pub(in crate::features) pending_ssh_config: Option<SshSessionConfig>,
    pub(in crate::features) pending_ai_execution_profile: AiExecutionProfile,
    pub(in crate::features) pending_session_custom_name: Option<String>,
    pub(in crate::features) pending_session_tab_color: Option<u32>,
    pub(in crate::features) pending_session_after_id: Option<String>,
    pub(in crate::features) pending_session_insert_index: Option<usize>,
    pub(in crate::features) pending_terminal_seed_output: Option<String>,
    ...
    pub(in crate::features) pending_startup_command: Option<StartupCommandRequest>,
    pub(in crate::features) pending_session_multiplex_key: Option<String>,
    pub(in crate::features) pending_source_connection_id: Option<String>,

...
pub struct NyaTermApp {
    ...
    pub(in crate::features) connection_import_dialog_open: bool,
    pub(in crate::features) connection_import_path_prompt: Option<ConnectionImportSource>,
    pub(in crate::features) connection_import_focus: FocusHandle,
    ...
    pub(in crate::features) quick_command_sort_menu_open: bool,
    pub(in crate::features) quick_command_view_menu_open: bool,
    pub(in crate::features) quick_command_ai_popover_open: bool,
    pub(in crate::features) quick_command_ai_prompt_draft: String,
    /// Open row overflow/context menu (Tauri QuickCommands more/context menu).
    pub(in crate::features) quick_command_menu: Option<QuickCommandRowMenuState>,
    ...
    pub(in crate::features) quick_switch_marked_text: String,

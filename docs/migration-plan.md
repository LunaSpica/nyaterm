...
## 2026-07-12 Sync history copy densify

- Sync/Backup history rows densify spacing and add Copy message when details
  are expanded (Tauri HistoryEntryRow copy parity).

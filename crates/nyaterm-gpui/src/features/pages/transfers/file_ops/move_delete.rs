...
impl NyaTermApp {
    ...
    pub(in crate::features) fn submit_transfer_move(&mut self, window: &mut Window, cx: &mut Context<Self>) {
    ...
    pub(in crate::features) fn submit_transfer_delete(&mut self, window: &mut Window, cx: &mut Context<Self>) {

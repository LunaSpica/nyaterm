...
pub(crate) fn terminal_key_bytes(event: &KeyDownEvent) -> Option<Vec<u8>> {
...
pub(crate) fn trim_terminal_output(output: &mut String) {
...
pub(crate) fn initial_terminal_screen() -> TerminalScreen {
    terminal_screen_from_output(INITIAL_TERMINAL_BANNER)
}
pub(crate) fn terminal_screen_from_output(output: &str) -> TerminalScreen {

...
pub(super) fn transfer_browser_parent_entry_row(
    ...
    div()
        ...
        .child(transfer_browser_text_cell(column_widths.size, "-"))
        .child(transfer_browser_text_cell(column_widths.permissions, ""))
        .child(transfer_browser_text_cell(column_widths.owner, ""))
        .child(transfer_browser_text_cell(column_widths.group, ""))
        .child(
            div()

...
pub(super) use nyaterm_core::{
    ...
    detect_credential_prompt_kind, export_diagnostics_archive,
    find_password_only_fallback_credentials, get_credential_prompt_pattern, get_tracked_command,
    get_tracked_submission_command, is_default_password_prompt, is_pager_search_or_command_input,
    ...
    resync_from_terminal_line, search_command_sources, strip_terminal_control_sequences,
    terminal_input_fanout_status, terminal_mouse_report_should_send,
...
pub(super) use crate::models::{
    ...
    TerminalCellPos, TerminalContextMenuState, TerminalPerformanceMode, TerminalPerformanceOverlay,

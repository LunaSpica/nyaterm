...
| `features/prelude.rs` rough exported-token count | 234 | Still a broad shared prelude; two hundred eleven low-frequency transport/core/http/model exports are now explicit imports. |

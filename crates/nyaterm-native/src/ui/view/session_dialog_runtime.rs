...
impl NyaTermApp {
    pub(in crate::ui::view) fn open_rename_session(
        &mut self,
        session_id: String,
        window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub(in crate::ui::view) fn close_rename_session(&mut self, cx: &mut Context<Self>) {
    ...
    pub(in crate::ui::view) fn submit_rename_session(&mut self, cx: &mut Context<Self>) {
    ...
    pub(in crate::ui::view) fn handle_rename_key_down(
        &mut self,
        event: &KeyDownEvent,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::ui::view) fn open_startup_command_dialog(
        &mut self,
        window: &mut Window,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::ui::view) fn open_startup_command_dialog_for(
        &mut self,
    ...
    pub(in crate::ui::view) fn close_startup_command_dialog(&mut self, cx: &mut Context<Self>) {
    ...
    pub(in crate::ui::view) fn adjust_startup_command_delay(
        &mut self,
        delta_ms: i64,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::ui::view) fn submit_startup_command_dialog(
        &mut self,
        window: &mut Window,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::ui::view) fn handle_startup_command_key_down(
        &mut self,
        event: &KeyDownEvent,
        window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub(in crate::ui::view) fn active_session_name(&self) -> Option<String> {

...
pub(super) use nyaterm_core::{
    ...
    GithubGistHttpBackend, Group, InputSelectionRange, KeywordHighlightConfig, KnownHostCheck,
    ...
    SavedConnection, SavedCredential, SavedPassword, SnippetRemote, SshKey, TerminalInputState,
    ...
    can_suggest_from_tracked_command, can_suggest_from_tracker,
    ...
    get_tracked_submission_command, merge_model_discoveries, now_rfc3339, parse_agent_model_output,
    parse_agent_tool_call, parse_model_output, pull_local_snapshot, pull_snapshot_with_remote,
    push_local_snapshot, push_snapshot_with_remote, read_cloud_sync_history, redact_context,

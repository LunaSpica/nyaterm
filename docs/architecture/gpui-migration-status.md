...
| `features/prelude.rs` rough exported-token count | 242 | Still a broad shared prelude; two hundred three low-frequency transport/core/http/model exports are now explicit imports. |

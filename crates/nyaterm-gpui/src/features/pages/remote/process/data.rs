...
pub(in crate::features::pages::remote) fn process_matches(process: &RemoteProcess, normalized_query: &str) -> bool {
...
pub(in crate::features::pages::remote) fn top_process_ratio(processes: &[RemoteProcess], cpu: bool) -> f64 {
    processes
        .iter()
        .map(|process| {
            if cpu {
...
pub(in crate::features::pages::remote) fn process_display_mode(panel_width: f32) -> ProcessDisplayMode {
...
pub(in crate::features::pages::remote) fn process_details_height_px(mode: ProcessDisplayMode) -> f32 {

...
pub(in crate::ui::view) fn is_agent_command_card(card: &AiCommandCard) -> bool {
...
pub(in crate::ui::view) fn run_ai_ask_job(
    config_dir: PathBuf,
...
pub(in crate::ui::view) fn ai_job_cancelled(cancel: &Arc<AtomicBool>) -> bool {
    cancel.load(Ordering::Relaxed)
}

pub(in crate::ui::view) fn remote_command_observation(
...
pub(in crate::ui::view) fn observation_summary(observation: &CommandObservation) -> String {
...
pub(in crate::ui::view) fn ai_active_profile_drafts(settings: &AiSettings) -> (String, String) {
    settings
        .provider_profiles
        .iter()
...
pub(in crate::ui::view) fn ai_active_profile_api_key(settings: &AiSettings) -> Option<String> {
    settings
...
pub(in crate::ui::view) fn ai_usage_counts(store: &ConnectionStore) -> (usize, usize, usize) {

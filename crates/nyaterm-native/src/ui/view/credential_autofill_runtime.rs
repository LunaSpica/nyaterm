...
impl NyaTermApp {
    pub(in crate::ui::view) fn now_unix_ms() -> u64 {
        SystemTime::now()
    ...
    pub(in crate::ui::view) fn dismiss_credential_suggestions(&mut self, cx: &mut Context<Self>) {
    ...
    pub(in crate::ui::view) fn reset_credential_autofill(&mut self, cx: &mut Context<Self>) {
    ...
    pub(in crate::ui::view) fn is_credential_prompt_input_mode(&self) -> bool {
    ...
    pub(in crate::ui::view) fn feed_credential_autofill_output(
        &mut self,
        data: &[u8],
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::ui::view) fn detect_credential_prompt(&mut self, cx: &mut Context<Self>) {
    ...
    pub(in crate::ui::view) fn apply_selected_credential_suggestion(
        &mut self,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::ui::view) fn select_credential_suggestion(
        &mut self,
        credential: SavedCredential,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::ui::view) fn handle_credential_suggestion_key(
        &mut self,
        event: &KeyDownEvent,
        cx: &mut Context<Self>,
    ) -> bool {
    ...
    pub(in crate::ui::view) fn credential_suggestions_overlay(
        &self,
        cx: &mut Context<Self>,
    ) -> impl IntoElement {

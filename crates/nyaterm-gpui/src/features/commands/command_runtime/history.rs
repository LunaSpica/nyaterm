...
impl NyaTermApp {
    ...
    pub(in crate::features) fn active_session_history_command(&self, index: usize) -> Option<String> {
    ...
    pub(in crate::features) fn apply_command_search_result(&mut self, index: usize, execute: bool, cx: &mut Context<Self>) {
    ...
    pub(in crate::features) fn apply_history_command(&mut self, index: usize, execute: bool, cx: &mut Context<Self>) {
        if self.active_session_id.is_none() {
    ...
    pub(in crate::features) fn apply_ai_command_card(&mut self, index: usize, execute: bool, cx: &mut Context<Self>) {
    ...
    pub(in crate::features) fn record_session_command_history(&mut self, session_id: &str, command: &str) {

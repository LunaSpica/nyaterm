pub(crate) use nyaterm_terminal_gpui::{
    ...
    terminal_buffer_matches, terminal_byte_index_for_cell_col, terminal_is_zero_width_mark,
    terminal_key_bytes_with_mode, terminal_key_release_bytes_with_mode, terminal_keyword_rules_key,

...
impl NyaTermApp {
    pub(in crate::ui::view) fn cancel_quick_command_variable_prompt(
        &mut self,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::ui::view) fn submit_quick_command_variable_prompt(
        &mut self,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::ui::view) fn focus_quick_command_variable(
        &mut self,
        index: usize,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::ui::view) fn cycle_quick_command_variable_option(
        &mut self,
        index: usize,
        delta: isize,
        cx: &mut Context<Self>,
    ...
    pub(in crate::ui::view) fn handle_quick_command_variable_key_down(
        &mut self,
        event: &KeyDownEvent,
        cx: &mut Context<Self>,
    ) {

...
pub(super) use nyaterm_domain::{
    ...
    read_cloud_sync_history, redact_context, redact_sensitive_text, search_command_sources, TerminalInputState, apply_terminal_input_data,
    can_register_command_from_tracker, can_suggest_from_tracker, get_tracked_command,
    get_tracked_submission_command, resync_from_terminal_line,

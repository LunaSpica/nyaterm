...
impl NyaTermApp {
    ...
    pub(in crate::features) fn save_ai_command_card_value(&mut self, card: AiCommandCard, cx: &mut Context<Self>) {
    ...
    pub(in crate::features) fn apply_quick_command(&mut self, index: usize, execute: bool, cx: &mut Context<Self>) {
